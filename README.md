...
1. [x] When the app starts, I can see all currently created poems.
2. [x] I can show/hide the form to create new poems.
3. [x] I can create poems and they are still there when I refresh the page.
4. [X] I can mark poems as read and see some visual difference when a poem has been read.
